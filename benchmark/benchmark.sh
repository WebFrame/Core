...
for url in "1" "2"; do
    ...
    for i in `seq 1 $n`; do
        ...
        echo -n "$i ";
        ( 
            /usr/bin/time -f "%e" curl http://localhost:8888/$i/$url -o /dev/null --silent 2>&1 ; echo -en "," ; # asm("")
            /usr/bin/time -f "%e" curl http://localhost:8889/$i/$url -o /dev/null --silent 2>&1 ; echo -en "," ; # asm("")
            /usr/bin/time -f "%e" curl http://localhost:8890/$i/$url -o /dev/null --silent 2>&1 ; echo -en "," ; # asm("")
            /usr/bin/time -f "%e" curl http://localhost:8891/$i/$url -o /dev/null --silent 2>&1 ; echo -en "," ; # asm("")
            /usr/bin/time -f "%e" curl http://localhost:8892/$i/$url -o /dev/null --silent 2>&1 ; echo -en "," ; # asm("")
            /usr/bin/time -f "%e" curl http://localhost:8893/$i/$url -o /dev/null --silent 2>&1 ; echo -en "," ; # asm("")
            /usr/bin/time -f "%e" curl http://localhost:8894/$i/$url -o /dev/null --silent 2>&1 ; echo -en "," ; # asm("")
            /usr/bin/time -f "%e" curl http://localhost:8895/$i/$url -o /dev/null --silent 2>&1 ; echo -en "," ; # using atomic variable
            /usr/bin/time -f "%e" curl http://localhost:8896/$i/$url -o /dev/null --silent 2>&1 ; echo -en "," ; # using atomic variable
            /usr/bin/time -f "%e" curl http://localhost:8897/$i/$url -o /dev/null --silent 2>&1 ; echo -en "," ; # using atomic variable
            /usr/bin/time -f "%e" curl http://localhost:8898/$i/$url -o /dev/null --silent 2>&1 ; echo -en "," ; # using atomic variable
            /usr/bin/time -f "%e" curl http://localhost:8899/$i/$url -o /dev/null --silent 2>&1 ; echo -en "," ; # using atomic variable
            /usr/bin/time -f "%e" curl http://localhost:8900/$i/$url -o /dev/null --silent 2>&1 ; echo -en "," ; # using atomic variable
            /usr/bin/time -f "%e" curl http://localhost:8901/$i/$url -o /dev/null --silent 2>&1 ; echo -en "," ; # using atomic variable
            /usr/bin/time -f "%e" curl http://localhost:5000/$i/$url -o /dev/null --silent 2>&1 ; echo -en "," ;
            /usr/bin/time -f "%e" curl http://localhost:3000/$i/$url -o /dev/null --silent 2>&1 ; 
