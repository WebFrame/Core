...
namespace mime_types 
{
    constexpr std::string_view mime_types[][2] = {
        ...
        {".contact", "text/x-ms-contact; charset=utf-8"},
        ...
        {".csdproj", "text/plain; charset=utf-8"},
        ...
        {".dbproj", "text/plain; charset=utf-8"},
        ...
        {".disco", "text/xml; charset=utf-8"},
        {".divx", "video/divx"},
        {".dll", "application/x-msdownload"},
        {".dll.config", "text/xml; charset=utf-8"},
        {".dlm", "text/dlm; charset=utf-8"},
        ...
        {".dsw", "text/plain; charset=utf-8"},
        {".dtd", "text/xml; charset=utf-8"},
        {".dtsConfig", "text/xml; charset=utf-8"},
        {".dv", "video/x-dv"},
        ...
        {".exe.config", "text/xml; charset=utf-8"},
        {".f4v", "video/mp4"},
        ...
        {".group", "text/x-ms-group; charset=utf-8"},
        {".gsm", "audio/x-gsm"},
        {".gtar", "application/x-gtar"},
        {".gz", "application/x-gzip"},
        {".h", "text/plain; charset=utf-8"},
        {".hdf", "application/x-hdf"},
        {".hdml", "text/x-hdml; charset=utf-8"},
        {".heic", "image/heic"},
        ...
        {".inl", "text/plain; charset=utf-8"},
        {".ins", "application/x-internet-signup"},
        {".ipa", "application/x-itunes-ipa"},
        {".ipg", "application/x-itunes-ipg"},
        {".ipproj", "text/plain; charset=utf-8"},
        {".ipsw", "application/x-itunes-ipsw"},
        {".iqy", "text/x-ms-iqy; charset=utf-8"},
        ...
        {".jsx", "text/jscript; charset=utf-8"},
        ...
        {".odh", "text/plain; charset=utf-8"},
        {".odi", "application/vnd.oasis.opendocument.image"},
        {".odl", "text/plain; charset=utf-8"},
        ...
        {".pic", "image/pict"},
        {".pict", "image/pict"},
        {".pkgdef", "text/plain; charset=utf-8"},
        {".pkgundef", "text/plain; charset=utf-8"},
        ...
        {".qht", "text/x-html-insertion; charset=utf-8"},
        {".qhtm", "text/x-html-insertion; charset=utf-8"},
        {".qt", "video/quicktime"},
        ...
        {".rqy", "text/x-ms-rqy; charset=utf-8"},
        {".rtf", "application/rtf"},
        ...
        {".srf", "text/plain; charset=utf-8"},
        {".SSISDeploymentManifest", "text/xml; charset=utf-8"},
        ...
        {".tif", "image/tiff"},
        {".tiff", "image/tiff"},
        {".tlh", "text/plain; charset=utf-8"},
        {".tli", "text/plain; charset=utf-8"},
        ...
        {".user", "text/plain; charset=utf-8"},
        {".ustar", "application/x-ustar"},
        {".vb", "text/plain; charset=utf-8"},
        {".vbdproj", "text/plain; charset=utf-8"},
        {".vbk", "video/mpeg"},
        {".vbproj", "text/plain; charset=utf-8"},
        {".vbs", "text/vbscript; charset=utf-8"},
        {".vcf", "text/x-vcard; charset=utf-8"},
        {".vcproj", "application/xml"},
        {".vcs", "text/plain; charset=utf-8"},
        {".vcxproj", "application/xml"},
        {".vddproj", "text/plain; charset=utf-8"},
        {".vdp", "text/plain; charset=utf-8"},
        {".vdproj", "text/plain; charset=utf-8"},
        {".vdx", "application/vnd.ms-visio.viewer"},
        {".vml", "text/xml; charset=utf-8"},
        {".vscontent", "application/xml"},
        {".vsct", "text/xml; charset=utf-8"},
        {".vsd", "application/vnd.visio"},
        {".vsi", "application/ms-vsi"},
        {".vsix", "application/vsix"},
        {".vsixlangpack", "text/xml; charset=utf-8"},
        {".vsixmanifest", "text/xml; charset=utf-8"},
        {".vsmdi", "application/xml"},
        {".vspscc", "text/plain; charset=utf-8"},
        {".vss", "application/vnd.visio"},
        {".vsscc", "text/plain; charset=utf-8"},
        {".vssettings", "text/xml; charset=utf-8"},
        {".vssscc", "text/plain; charset=utf-8"},
        {".vst", "application/vnd.visio"},
        {".vstemplate", "text/xml; charset=utf-8"},
        ...
        {".xof", "x-world/x-vrml"},
        {".XOML", "text/plain; charset=utf-8"},
        {".xpm", "image/x-xpixmap"},
        {".xps", "application/vnd.ms-xpsdocument"},
        {".xrm-ms", "text/xml; charset=utf-8"},
        {".xsc", "application/xml"},
        {".xsd", "text/xml; charset=utf-8"},
        {".xsf", "text/xml; charset=utf-8"},
